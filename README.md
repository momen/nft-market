...
This project relies on [NFT Contracts](https://github.com/momen/nft-contracts) package and [NFT Lambda Service](https://github.com/momen/nft-market-service) for serving the metadata
...
It's been transferred to the [NFT Lambda Service](https://github.com/momen/nft-market-service) repository.
